...
class _AddPaymentScreenState extends State<AddPaymentScreen> {
  ...
  Future<void> _loadPreviousPayments() async {
    ...
    try {
      ...
      setState(() {
        _previousDuePayments = paymentSnapshot.docs.map((doc) {
          ...
          return Payment(
            ...
            customerBalanceAfterThis:
                (data['customerBalanceAfterThis'] as num?)?.toDouble() ?? 0.0,
          );
        }).toList();
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: payment.status.toLowerCase() == 'due'
                                        ? Colors.red.shade100
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    TextButton(
                                      onPressed: () =>
                                          _handlePreviousDuePayment(payment),
  ...
  void _handlePreviousDuePayment(Payment payment) {
    setState(() {
      _amountController.text = payment.amountDue.toString();
      _isCustomAmount = true;
      _noteController.text =
          'Paying previous due from ${DateFormat('dd MMM yyyy').format(payment.date)}';
    });
  ...
  void _handlePayAllDues() {
    setState(() {
      _amountController.text = _totalPreviousDue.toString();
      _isCustomAmount = true;
      _noteController.text = 'Paying all previous dues';
    });
    Navigator.pop(context); // Close the dialog
  }
  ...
  Future<void> _submitPayment() async {
    ...
    try {
      ...
      final paidAmount = isPartialPayment
    ...
    if (!selectedCustomer!.isActive || _isNewPlanActivation) {
      ...
      setState(() {
        selectedCustomer = Customer(
          ...
          setupBoxSerial: selectedCustomer!.setupBoxSerial,
          category: selectedCustomer!.category,
          monthlyPlan: _isNewPlanActivation
              ? _selectedPackageName!
              : selectedCustomer!.monthlyPlan,
          packageAmount: _isNewPlanActivation
              ? totalAmount
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      // Show different payment details based on payment type
                      if (isDue) ...[
                        _buildSummaryRow(
                          context,
                          'Total Due Amount',
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'This payment will be marked as due',
                          style: theme.textTheme.bodySmall?.copyWith(
  ...
  Color _getPaymentStatusColor(ColorScheme colorScheme) {
    if (isDue) return colorScheme.error;
    if (isPartialPayment) return colorScheme.secondary;
    return colorScheme.tertiary;
  }

  String _getPaymentStatusText() {
    if (isDue) return 'Due Payment';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: selectedCustomer != null
          ? Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                                ...
                                ConstrainedBox(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (value) {
                                      if (value != null &&
                                          packages.isNotEmpty) {
                                        final selectedPackage = packages.any(
                                          (p) => p['id'] == value,
                                        )
                                            ? packages.firstWhere(
                                                (p) => p['id'] == value,
      ...
      child: Column(
        ...
        children: [
          ...
          ModernTextField(
            ...
            controller: TextEditingController(text: paymentMode),
            onTap: () {
                ...
                builder: (context) => ListView(
                  ...
                  children: paymentModes.map((mode) {
                    return ListTile(
                      leading: Icon(
                        _getModeIcon(mode),
                        color: mode == paymentMode ? colorScheme.primary : null,
                      ),
                      title: Text(mode),
